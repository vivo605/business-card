  ...
  return (
    <div className="all">
      ...
      <section id="hero">
        ...
        <h4>Я Vivo. Извените но мобильная версия сайта находится в разработке.Скоро всё заработает в стандартном режиме) Приблезительная дата релиза: 24 января 2025 года)</h4>
      </section>
